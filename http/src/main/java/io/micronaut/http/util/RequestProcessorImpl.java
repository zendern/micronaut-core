...
public class RequestProcessorImpl implements RequestProcessor {
    ...
    public boolean shouldProcessRequest(RequestProcessorMatcher matcher, HttpRequest<?> request) {
        ...
        return shouldProcessRequest(matcher, serviceId, uri);
    }
     ...
     * @return true if the request should be processed
     */
    public boolean shouldProcessRequest(RequestProcessorMatcher matcher, Optional<String> serviceId, String uri) {
        if (matcher.getServiceIdRegex() != null && serviceId.isPresent()) {
