 ...
 */
@Filter("/**")
@Requires(beans = {TenantWriter.class, TenantResolver.class})
...
public class TenantPropagationHttpClientFilter implements HttpClientFilter  {
    ...
    protected final TenantPropagationConfiguration tokenPropagationConfiguration;
    ...
    public TenantPropagationHttpClientFilter(TenantResolver tenantResolver,
                                             ...
                                             TenantPropagationConfiguration tokenPropagationConfiguration,
