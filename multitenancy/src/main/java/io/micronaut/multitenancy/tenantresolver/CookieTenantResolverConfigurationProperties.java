...
public class CookieTenantResolverConfigurationProperties implements CookieTenantResolverConfiguration {
    ...
    /**
     * Wether to enable {@link io.micronaut.multitenancy.tenantresolver.CookieTenantResolver}. Default value ({@value #DEFAULT_ENABLE}).
    ...
    /**
     * Http Header name which should be used to resolve the tenant id from. Default value ({@value io.micronaut.multitenancy.tenantresolver.CookieTenantResolverConfiguration#DEFAULT_COOKIENAME}).
