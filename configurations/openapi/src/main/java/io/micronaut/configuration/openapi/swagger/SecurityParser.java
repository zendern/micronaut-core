...
public class SecurityParser {
    ...
    public static Optional<Map.Entry<String, SecurityScheme>> getSecurityScheme(io.swagger.v3.oas.annotations.security.SecurityScheme securityScheme) {
        ...
        Map.Entry<String, SecurityScheme> result = new AbstractMap.SimpleEntry<>(key, securitySchemeObject);
